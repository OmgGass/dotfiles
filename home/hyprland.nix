...
services.dunst = {
  ...
  wayland.windowManager.hyprland = {
    ...
    extraConfig = ''
      # Scripts de usuário e outros comandos de inicialização
    ...
    settings = {
      ...
      env = [
        "GRIMBLAST_SCREENSHOTS_DIR,$HOME/Pictures/Screenshots"
      ...
      # Atalhos de teclado
      bind = [
        "${mainMod} SHIFT, P, exec, grimblast --notify --freeze copy area"
